          ...
          <div className="header-contact">
            ...
            {cv.contact.linkedin && (
              <a href={cv.contact.linkedin} target="_blank" rel="noopener noreferrer" className="contact-link">
                <svg className="brand-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-label="LinkedIn">
            ...
            {cv.contact.github && (
              <a href={cv.contact.github} target="_blank" rel="noopener noreferrer" className="contact-link">
                <svg className="brand-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-label="GitHub">
